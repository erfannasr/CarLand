  ...
  return (
    <section className="section flex items-center " id="why">
      <div className="container mx-auto">
        ...
        >
          Unmatched excellece and customer satisfaction
        </motion.h2>
        <motion.p
        ...
        className="flex flex-wrap justify-center xl:grid xl:grid-cols-3 gap-4 xl:gap-y-0 xl:gap-x-[30px] mb-40">
          {/* item 1 */}
          <div className="flex flex-col items-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <p className="hidden xl:flex">We prioritize your need we go above and beyond to ensure your experinece with us is nothing short of outstanding.</p>
          </div>
